...
const commodity1 = {name: "새우깡", price: 1500, discount: 10};
const commodity2 = {name: "홈런볼", price: 2000, discount: 5};
const commodity3 = {name: "포카칩", price: 2500 };
const commodity4 = {name: "칙촉", price: 3000, discount: 15};
const commodity5 = {name: "오잉", price: 1800 };

function average(name, price, ...discount) {
