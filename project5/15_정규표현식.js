...
// 정규 표현식 객체 생성 방법
const regex = /World/; // 리터럴방식

const regex2 = new RegExp("World"); // 생성자 방식
...
patt = /^\d{5}$/; 
console.log(patt.test(postalcode)); // test는 우편번호가 패턴이 맞는지 확인 (참,거짓 확인)

// 전화번호
// 010-2312-3354
let tel = "010-2312-3354";

//^는 문자열의 시작, (010)와 -는 문자 그대로, \d{4}는 숫자가 4개 연속으로 나오는 것, $는 문자열의 끝
patt = /^(010)-\d{4}-\d{4}$/; 
